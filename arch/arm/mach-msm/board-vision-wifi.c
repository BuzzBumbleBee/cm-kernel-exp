/* linux/arch/arm/mach-msm/board-vision-wifi.c
*/
...
int vision_wifi_set_carddetect(int on);
...
static void *vision_wifi_mem_prealloc(int section, unsigned long size)
{
...
int __init vision_init_wifi_mem(void)
{
	int i;
...
static struct resource vision_wifi_resources[] = {
	[0] = {
...
static struct wifi_platform_data vision_wifi_control = {
	.set_power      = vision_wifi_power,
...
static struct platform_device vision_wifi_device = {
	.name           = "bcm4329_wlan",
	.id             = 1,
	.num_resources  = ARRAY_SIZE(vision_wifi_resources),
	.resource       = vision_wifi_resources,
	.dev            = {
		.platform_data = &vision_wifi_control,
	},
};

extern unsigned char *get_wifi_nvs_ram(void);

static unsigned vision_wifi_update_nvs(char *str)
{
